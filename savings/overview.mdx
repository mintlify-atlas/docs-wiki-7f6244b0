...
```mermaid
flowchart LR
    API[SavingsAccountsApiResource<br/>FixedDepositAccountsApiResource<br/>RecurringDepositAccountsApiResource<br/>SavingsProductsApiResource<br/>FixedDepositProductsApiResource<br/>RecurringDepositProductsApiResource<br/>InterestRateChartsApiResource] --> Handlers[Command handlers<br/>portfolio/savings/handler/*]
    Handlers --> Write[Write platform services<br/>portfolio/savings/service/*WritePlatformService*]
    Write --> Assemblers[Assemblers<br/>portfolio/savings/domain/*Assembler*]
    Write --> Domain[Domain entities<br/>portfolio/savings/domain/*]
    Domain --> JPA[JPA / EclipseLink]
    JPA --> DB[(MariaDB / PostgreSQL)]

    Read[Read platform services<br/>portfolio/savings/service/*ReadPlatformService*] --> JdbcTpl[JdbcTemplate]
    JdbcTpl --> DB
    API --> Read
```
