...
The fee component is the natural extension point — override the quote handling in a custom `InteropService` implementation if your switch agreement has bespoke pricing.
